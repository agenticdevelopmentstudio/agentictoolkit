 ...
 * door — the "Debug Options" row at the end of the avatar menu (signed in), or the
 * header's Debug Options button (signed out), both from `useDebugOptions` — also opens

...
domain: agentictoolkit://cookbook/core/system-windows/matching/window-matching
type: ingredient
version: 1.0.1
status: review
language: en
...
- persistence
depends-on:
- agentictoolkit://cookbook/core/system-windows/core-system-windows
related:
- agentictoolkit://cookbook/core/system-windows/matching/heuristics
- agentictoolkit://cookbook/core-macos/system-windows/core-mac-os-system-windows
references:
...
specified in [Window Matching Core System Windows](agentictoolkit://cookbook/core/system-windows/core-system-windows).
...
[Window Matching Heuristics](agentictoolkit://cookbook/core/system-windows/matching/heuristics);

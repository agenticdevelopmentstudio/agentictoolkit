...
domain: agentictoolkit://cookbook/status-server/monitor/sync
type: ingredient
version: 1.0.1
status: review
language: en
...
- agentictoolkit://cookbook/status-server/monitor/reconcile-stuck-deploys
- agentictoolkit://cookbook/status-server/board
- agentictoolkit://cookbook/status-server/monitor/issues
references:
...
| Platform | Path |
|----------|------|
| web | `packages/web/packages/status-server/src/monitor/sync.ts` |

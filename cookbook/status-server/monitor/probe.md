...
domain: agentictoolkit://cookbook/status-server/monitor/probe
type: ingredient
version: 1.0.1
status: review
language: en
...
- agentictoolkit://cookbook/status-server/monitor/endpoint-kinds
references:
...
| Platform | Path |
|----------|------|
| web | `packages/web/packages/status-server/src/monitor/probe.ts` |

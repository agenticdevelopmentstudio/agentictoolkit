...
domain: agentictoolkit://cookbook/status-server/monitor/provider-deploy
type: ingredient
version: 1.0.1
status: review
language: en
...
- agentictoolkit://cookbook/status-server/monitor/deploy-view
references:
...
| Platform | Path |
|----------|------|
| web | `packages/web/packages/status-server/src/monitor/provider-deploy.ts` |

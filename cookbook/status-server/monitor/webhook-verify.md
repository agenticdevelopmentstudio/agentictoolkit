...
domain: agentictoolkit://cookbook/status-server/monitor/webhook-verify
type: ingredient
version: 1.0.1
status: review
language: en
...
related:
- agentictoolkit://cookbook/status-server/monitor/webhook-events
references:
...
| Platform | Path |
|----------|------|
| web | `packages/web/packages/status-server/src/monitor/webhook-verify.ts` |

...
domain: agentictoolkit://cookbook/status-server/openapi/paths
type: ingredient
version: 1.0.1
status: review
language: en
...
- agentictoolkit://cookbook/status-server/middleware
- agentictoolkit://cookbook/status-server/monitor/types
...
| Platform | Path |
|----------|------|
| web | `packages/web/packages/status-server/src/openapi/paths/` |

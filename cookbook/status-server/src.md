...
title: Status Server
domain: agentictoolkit://cookbook/status-server/src
type: ingredient
version: 1.0.2
status: review
language: en
...
| Platform | Path |
|----------|------|
| web | `packages/web/packages/status-server/src/app.ts` |
| web | `packages/web/packages/status-server/src/scheduler.ts` |
| web | `packages/web/packages/status-server/src/types.ts` |

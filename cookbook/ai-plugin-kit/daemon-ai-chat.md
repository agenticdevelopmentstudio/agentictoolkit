...
title: DaemonAIChat
domain: agentictoolkit://cookbook/ai-plugin-kit/daemon-ai-chat
type: ingredient
version: 1.0.1
status: review
language: en
...
- agentictoolkit://cookbook/ai-plugin-kit/ai-request-spec
- agentictoolkit://cookbook/ai-plugin-kit/ai-stream-event
- agentictoolkit://cookbook/ai-plugin-kit/ai-provider-configuration
- agentictoolkit://cookbook/ai-plugin-kit/ai-provider-config-keys
- agentictoolkit://cookbook/ai-plugin-kit/daemon-provider-resolver

...
domain: agentictoolkit://cookbook/database
type: ingredient
version: 1.0.1
status: review
language: en
...
`MarkdownStore` (see [Markdown Core](agentictoolkit://cookbook/markdown)),
and `ProjectDatabase` (see
[Project Database](agentictoolkit://cookbook/macos/features/projects/project-database)),

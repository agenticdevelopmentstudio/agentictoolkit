...
title: WindowManager
domain: agentictoolkit://cookbook/macos/system-integration/window-manager
type: ingredient
version: 1.0.1
status: review
language: en
...
related:
- agentictoolkit://cookbook/macos/system-integration/window-manager/recents
references: []
approved-by: ''
approved-date: ''
---
...
- `frames`, a `WindowFrameManager` that persists window frames and visibility
  ...
  [ScreenManager](agentictoolkit://cookbook/macos/system-integration/window-manager/screen-manager)
  recipes);
...
- an app-termination latch (`isTerminating`) that lets
  [SingleWindowController](agentictoolkit://cookbook/macos/system-integration/window-manager/windows/single-window-controller)

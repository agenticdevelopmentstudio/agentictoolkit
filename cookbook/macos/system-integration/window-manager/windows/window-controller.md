...
domain: agentictoolkit://cookbook/macos/system-integration/window-manager/windows/window-controller
type: ingredient
version: 1.1.2
status: review
language: en
...
`agentictoolkit://cookbook/macos/system-integration/window-manager/windows/single-window-controller`, which this recipe depends
...
- **inherits-single-window-controller-lifecycle**: `WindowController<ViewControllerType>`
  ...
  `agentictoolkit://cookbook/macos/system-integration/window-manager/windows/single-window-controller`), since it overrides no
...
- Role/trait: Not applicable — the component sets no `NSAccessibility` role,
  ...
  `agentictoolkit://cookbook/macos/system-integration/window-manager/windows/single-window-controller`); any content-level role
...
in `agentictoolkit://cookbook/macos/system-integration/window-manager/windows/single-window-controller`).
...
(`agentictoolkit://cookbook/macos/system-integration/window-manager/windows/single-window-controller`); restating its

...
domain: agentictoolkit://cookbook/macos/system-integration/window-manager/windows/single-window-controller
type: ingredient
version: 1.1.2
status: review
language: en
...
- agentictoolkit://cookbook/macos/system-integration/window-manager/windows/window-controller

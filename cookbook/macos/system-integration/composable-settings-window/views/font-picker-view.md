...
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-picker-view
type: ingredient
version: 1.1.2
status: review
language: en
...
- appkit
depends-on:
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-chooser-button
related:
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/color-picker-view
...
- **Corner radius**: Not applicable - the component adds no custom layer or
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-chooser-button` for the button's own
  corner treatment).
...
- **Min/Max size**: Not applicable - no explicit min/max width or height
  ...
  fixed width is documented in `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-chooser-button`).
...
- **Role/trait**: Not observable beyond AppKit's defaults - no
  ...
  role (see `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-chooser-button`); `label` is a
...
- **SwiftUI**: Compose an `HStack` with `Text(viewModel.title)` and a
  ...
  `FontChooserButton`, per `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-chooser-button`'s
...
- **Compose**: Use a `Row` with a leading `Text(title)` and a trailing
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-chooser-button`'s Compose note); commit the
...
- **AppKit / UIKit** (source platform): Source file
  ...
  **flags-an-uninstalled-font-in-its-title**. There is no UIKit code
  ...
  (see `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-chooser-button`'s own AppKit/UIKit
...
- **WinUI 3** (the reason this recipe exists): Build the row as a `Grid`
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-chooser-button`'s own WinUI 3 note (its
...
documented at `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/color-picker-view#requirements/owns-on-change`;

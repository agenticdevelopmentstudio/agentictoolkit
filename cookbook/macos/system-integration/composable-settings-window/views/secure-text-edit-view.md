...
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/secure-text-edit-view
type: ingredient
version: 1.1.2
status: review
language: en
...
See `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view` for everything a caller
...
`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#requirements` (arranges-row-layout,
...
documented at `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#appearance`;
...
| All other states | Editing, Committed, Placeholder shown, Disabled, Pressed, and Loading are inherited unmodified from `TextEditView`; see `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#states`. |
...
- **Label requirements**: Neither `TextEditView.swift` (whose `init`
  ...
  (`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/checkbox-view`), which links its switch to its
...
- **Contrast**: Inherited unmodified from `TextEditView` — `label` and
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#design-decisions` and
...
`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#test-vectors`.
...
`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#edge-cases`.
...
`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#configuration`. The only thing this
...
- **Data collected**: The field's typed value — per the source's own doc
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#privacy` for the storage,
...
- **Retention**: Inherited unmodified from `TextEditView` — the value lives
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#privacy`.
...
- **AppKit/UIKit** (source platform): Source file
  ...
  (`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view`) supplies everything else — row
...
at `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#design-decisions` and are not
repeated here.
...
`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/text-edit-view#design-decisions`).

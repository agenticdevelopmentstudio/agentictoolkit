...
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/radio-button-choice-view
type: ingredient
version: 1.1.2
status: review
language: en
...
depends-on: []
related:
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/choice-slider-view
references: []
approved-by: ''
approved-date: ''
---

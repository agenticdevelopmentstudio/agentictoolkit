...
title: CheckboxView
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/checkbox-view
type: ingredient
version: 1.1.1
status: review
language: en
...
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/stepper-view
references: []
approved-by: ''
approved-date: ''
---

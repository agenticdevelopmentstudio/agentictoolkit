...
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/panel-heading-view
type: ingredient
version: 1.1.2
status: review
language: en
...
- appkit
depends-on:
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/explanation-view
related:
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/explanation-view
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/header-view
...
- **Caption text reassigned after construction**: `PanelHeadingView` exposes
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/explanation-view#requirements/updates-text-via-label-property`;

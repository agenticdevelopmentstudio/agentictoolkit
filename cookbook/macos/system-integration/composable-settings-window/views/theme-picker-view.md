...
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/theme-picker-view
type: ingredient
version: 1.1.2
status: review
language: en
...
related:
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/font-picker-view
references: []
approved-by: ''
approved-date: ''
---
...
- **commits-selection-through-the-active-theme-setting**: WHEN the user picks
  ...
  `PopupMenuChoiceView`, per `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/popup-menu-choice-view`)
...
- **Label requirements**: Not applicable to this file — linking the popup's
  ...
  scope; see `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/popup-menu-choice-view`.
...
- **Null/empty input**: `store` (`ThemeStore`) is a non-optional, defaulted
  ...
  per `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/popup-menu-choice-view`) — `ThemePickerView.swift`
...
- **SwiftUI**: Compose a `VStack(alignment: .leading, spacing: 10)` with a
  ...
  (mirroring `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/popup-menu-choice-view`'s own SwiftUI
...
- **Compose**: A `Column` with an `ExposedDropdownMenuBox`/`DropdownMenu`
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/popup-menu-choice-view`) followed by a preview
...
- **React/Web**: A flex column (`display: flex; flex-direction: column; gap:
  ...
  `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/popup-menu-choice-view`'s web note) above a
...
- **WinUI 3**: Build the row as a vertical
  ...
  matching `agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/popup-menu-choice-view`'s own WinUI 3
...
`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/popup-menu-choice-view`), but the popup's visible

...
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/settings-card-views
type: ingredient
version: 1.1.2
status: review
language: en
...
Not applicable: the source contains no feature-flag check; all six APIs construct and lay out unconditionally.

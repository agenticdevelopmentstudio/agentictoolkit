...
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/captioned-slider-view
type: ingredient
version: 1.1.2
status: review
language: en
...
depends-on: []
related:
- agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/slider-view

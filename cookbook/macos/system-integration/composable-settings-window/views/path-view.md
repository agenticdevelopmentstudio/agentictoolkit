...
title: PathView
domain: agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/path-view
type: ingredient
version: 1.1.2
status: review
language: en
...
[ExplanationView](agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/explanation-view) word-wraps,

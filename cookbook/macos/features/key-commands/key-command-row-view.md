...
domain: agentictoolkit://cookbook/macos/features/key-commands/key-command-row-view
type: ingredient
version: 1.1.2
status: review
language: en
...
depends-on: []
related:
- agentictoolkit://cookbook/macos/features/key-commands/key-command-capture-field
references: []
approved-by: ''
approved-date: ''
---
...
- **Role/trait**: `KeyCommandRowView` sets no accessibility role on itself.
  ...
  **links-toggle-accessibility-title**. The capture field's own role belongs
  to its component; see `agentictoolkit://cookbook/macos/features/key-commands/key-command-capture-field`,
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/Features/KeyCommands/KeyCommandRowView.swift` |

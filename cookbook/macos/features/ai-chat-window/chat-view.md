...
title: ChatView
domain: agentictoolkit://cookbook/macos/features/ai-chat-window/chat-view
type: ingredient
version: 1.1.3
status: review
language: en
...
- transcript
depends-on:
- agentictoolkit://cookbook/macos/features/ai-chat-window/chat-day-banner-view

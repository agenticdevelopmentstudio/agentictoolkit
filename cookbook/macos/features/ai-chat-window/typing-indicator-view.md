...
domain: agentictoolkit://cookbook/macos/features/ai-chat-window/typing-indicator-view
type: ingredient
version: 1.1.2
status: review
language: en
...
depends-on: []
related:
- agentictoolkit://cookbook/macos/features/ai-chat-window/chat-transcript-row-view
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/Features/AIChatWindow/TypingIndicatorView.swift` |

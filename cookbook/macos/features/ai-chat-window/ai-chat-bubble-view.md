...
domain: agentictoolkit://cookbook/macos/features/ai-chat-window/ai-chat-bubble-view
type: ingredient
version: 1.1.2
status: review
language: en
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/Features/AIChatWindow/AIChatBubbleView.swift` |

...
domain: agentictoolkit://cookbook/macos/features/projects/project-workspace
type: ingredient
version: 1.0.1
status: review
language: en
...
- agentictoolkit://cookbook/core/git
references:
...
- **Concurrent access**: Every property and method here is confined to the
  ...
  `agentictoolkit://cookbook/macos/features/projects/project-controller`), not
...
- **Offline or disconnected state**: Not applicable in the network sense —
  ...
  not this file's (see `agentictoolkit://cookbook/core/git`).
...
- **Storage**: Everything persisted here (tabs, pane state, project settings,
  ...
  `agentictoolkit://cookbook/macos/features/projects/project-database` and
  `agentictoolkit://cookbook/macos/features/projects/project-database-layout` for
...
- **React/Web**: There is no local filesystem worktree or SQLite file to
  ...
  `agentictoolkit://cookbook/macos/features/projects/project-database`), and would
...
- **AppKit / UIKit**: The source already is this tier — a plain
  ...
  `agentictoolkit://cookbook/macos/features/projects/project-controller`, iOS
...
- **WinUI 3**: Port `ProjectWorkspace` as a plain C# class with no interface
  ...
  `agentictoolkit://cookbook/macos/features/projects/branch-controller`'s WinUI
  ...
  **pane-state-list-json-encoded** with `System.Text.Json` in place of
  ...
  the same SQLite-backed port `agentictoolkit://cookbook/macos/features/projects/project-database`
  and `agentictoolkit://cookbook/macos/features/projects/project-database-layout`

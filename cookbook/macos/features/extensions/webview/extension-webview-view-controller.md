...
domain: agentictoolkit://cookbook/macos/features/extensions/webview/extension-webview-view-controller
type: ingredient
version: 1.1.2
status: review
language: en
...
- agentictoolkit://cookbook/macos/ui/view-controllers/composable-tabs/composable-tabs-view-registry
related:
- agentictoolkit://cookbook/macos/features/extensions/webview/webview-panel-view-controller
...
**Rationale**: It is one verb with one production implementation, so a protocol would exist for a single conformer; taking it as a closure parameter also lets it be supplied to this component after construction, without needing a stateful lookup type. See `agentictoolkit://cookbook/macos/features/extensions/webview/webview-panel-view-controller` for the panel this closure returns.
**Approved**: pending

...
domain: agentictoolkit://cookbook/macos/features/extensions/vs-code-api/extension-quick-pick-presenting
type: ingredient
version: 1.0.1
status: review
language: en
...
depends-on: []
related:
  - agentictoolkit://cookbook/macos/features/extensions/ui/extension-quick-pick-view-controller
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/Features/Extensions/VSCodeAPI/ExtensionQuickPickPresenting.swift` |

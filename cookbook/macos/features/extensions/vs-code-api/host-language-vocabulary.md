...
domain: agentictoolkit://cookbook/macos/features/extensions/vs-code-api/host-language-vocabulary
type: ingredient
version: 1.0.1
status: review
language: en
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/Features/Extensions/VSCodeAPI/HostLanguageVocabulary.swift` |

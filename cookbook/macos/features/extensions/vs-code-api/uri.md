...
title: Uri
domain: agentictoolkit://cookbook/macos/features/extensions/vs-code-api/uri
type: ingredient
version: 1.0.1
status: review
language: en
...
- agentictoolkit://cookbook/macos/features/extensions/vs-code-api/main-thread-diagnostics
- agentictoolkit://cookbook/macos/features/extensions/vs-code-api/extension-webview-presenting
- agentictoolkit://cookbook/macos/features/extensions/vs-code-api/language-model-message-vocabulary
references:
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/Features/Extensions/VSCodeAPI/Uri.swift` |

...
domain: agentictoolkit://cookbook/macos/features/extensions/vs-code-api/main-thread-tree-views
type: ingredient
version: 1.0.1
status: review
language: en

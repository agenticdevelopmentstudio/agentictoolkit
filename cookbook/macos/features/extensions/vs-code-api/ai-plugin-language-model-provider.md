...
domain: agentictoolkit://cookbook/macos/features/extensions/vs-code-api/ai-plugin-language-model-provider
type: ingredient
version: 1.0.1
status: review
language: en
...
depends-on:
  ...
  - agentictoolkit://cookbook/ai-plugin-kit/plugin-transport

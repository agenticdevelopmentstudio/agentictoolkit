...
domain: agentictoolkit://cookbook/macos/features/extensions/vs-code-api/main-thread-diagnostics
type: ingredient
version: 1.0.1
status: review
language: en

...
domain: agentictoolkit://cookbook/macos/ui/controls/spacing/spacing-control
type: ingredient
version: 1.1.2
status: review
language: en
...
depends-on: []
related:
- agentictoolkit://cookbook/macos/ui/view-controllers/composable-tabs/pane-spacing
...
- **Label requirements**: The four or two number fields
  ...
  (`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/captioned-slider-view#accessibility/label-requirements`).

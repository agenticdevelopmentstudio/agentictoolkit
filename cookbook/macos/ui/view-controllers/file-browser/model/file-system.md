...
domain: agentictoolkit://cookbook/macos/ui/view-controllers/file-browser/model/file-system
type: ingredient
version: 1.0.1
status: review
language: en
...
[File Tree Outline View Controller](agentictoolkit://cookbook/macos/ui/view-controllers/file-browser/views/file-tree-outline-view-controller)
and
[File Browser View Controller](agentictoolkit://cookbook/macos/ui/view-controllers/file-browser/file-browser-view-controller)
...
- **AppKit / UIKit**: The source
  ...
  (see [File Tree Outline View Controller](agentictoolkit://cookbook/macos/ui/view-controllers/file-browser/views/file-tree-outline-view-controller)).

...
domain: agentictoolkit://cookbook/macos/ui/view-controllers/file-browser/views/file-editor-view
type: ingredient
version: 1.1.2
status: review
language: en
...
depends-on: []
related:
- agentictoolkit://cookbook/macos/ui/view-controllers/document-pane/document-editor-view-controller
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/UI/ViewControllers/FileBrowser/Views/FileEditorView.swift` |

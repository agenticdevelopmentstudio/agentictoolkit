...
domain: agentictoolkit://cookbook/macos/ui/view-controllers/file-browser/views/content-viewer-view
type: ingredient
version: 1.1.2
status: review
language: en
...
- agentictoolkit://cookbook/macos/ui/view-controllers/file-browser/file-browser-view-controller
related: []
references: []
approved-by: ''
approved-date: ''
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/UI/ViewControllers/FileBrowser/Views/ContentViewerView.swift` |

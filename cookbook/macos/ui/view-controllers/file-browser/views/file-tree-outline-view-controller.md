...
domain: agentictoolkit://cookbook/macos/ui/view-controllers/file-browser/views/file-tree-outline-view-controller
type: ingredient
version: 1.1.2
status: review
language: en
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/UI/ViewControllers/FileBrowser/Views/FileTreeOutlineViewController.swift` |

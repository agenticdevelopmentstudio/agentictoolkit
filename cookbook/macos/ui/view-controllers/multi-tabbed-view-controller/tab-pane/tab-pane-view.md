...
title: TabPaneView
domain: agentictoolkit://cookbook/macos/ui/view-controllers/multi-tabbed-view-controller/tab-pane/tab-pane-view
type: ingredient
version: 1.1.3
status: review
language: en
...
bar of [MultiTabbedViewController](agentictoolkit://cookbook/macos/ui/view-controllers/multi-tabbed-view-controller):

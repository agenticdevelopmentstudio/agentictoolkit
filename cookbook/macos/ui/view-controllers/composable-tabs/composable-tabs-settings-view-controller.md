...
domain: agentictoolkit://cookbook/macos/ui/view-controllers/composable-tabs/composable-tabs-settings-view-controller
type: ingredient
version: 1.1.2
status: review
language: en
...
- agentictoolkit://cookbook/macos/ui/controls/spacing/spacing-control
related: []
references: []
approved-by: ''
approved-date: ''
...
- **Corner radius**: `SettingsLayout.default[.cardCornerRadius]` on every
  ...
  `ThemedBox` — see agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/group-view#appearance for the
...
- **Padding**: The sheet itself contributes 0pt of padding around the topic
  ...
  from its card — see agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/group-view#appearance for the
...
- **Background**: The sheet's root view paints `palette.nsColor(.windowBackground)`
  ...
  `GroupView` — see agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/group-view#appearance for its
...
- **Border**: Each card's `ThemedBox` has no border stroke of its own, and a
  ...
  agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/group-view#appearance for the current values

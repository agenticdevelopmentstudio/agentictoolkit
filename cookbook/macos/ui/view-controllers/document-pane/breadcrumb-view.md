...
domain: agentictoolkit://cookbook/macos/ui/view-controllers/document-pane/breadcrumb-view
type: ingredient
version: 1.1.2
status: review
language: en
...
depends-on: []
related:
- agentictoolkit://cookbook/macos/ui/view-controllers/document-pane/breadcrumb-popover-view-controller
references: []
approved-by: ''
approved-date: ''
---
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/macOS/UI/ViewControllers/DocumentPane/BreadcrumbView.swift` |

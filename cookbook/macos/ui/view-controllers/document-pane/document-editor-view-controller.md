...
domain: agentictoolkit://cookbook/macos/ui/view-controllers/document-pane/document-editor-view-controller
type: ingredient
version: 1.1.2
status: review
language: en
...
- appkit
depends-on:
- agentictoolkit://cookbook/macos/ui/view-controllers/document-pane/breadcrumb-view

...
domain: agentictoolkit://cookbook/macos/ui/help/help-content-view
type: ingredient
version: 1.1.2
status: review
language: en
...
- **Label requirements**: Satisfied for the fixed heading — it always reads
  ...
  (`agentictoolkit://cookbook/macos/system-integration/composable-settings-window/views/explanation-view`) covers its label behavior.

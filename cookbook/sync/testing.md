...
domain: agentictoolkit://cookbook/sync/testing
type: ingredient
version: 1.0.1
status: review
language: en
...
Use them to drive [SyncEngine](agentictoolkit://cookbook/sync/sync-engine) in unit
...
| Platform | Path |
|----------|------|
| apple | `packages/apple/AgenticToolkit/Sync/Testing/` |

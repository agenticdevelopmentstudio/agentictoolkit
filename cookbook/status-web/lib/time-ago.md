...
domain: agentictoolkit://cookbook/status-web/lib/time-ago
type: ingredient
version: 1.0.1
status: review
language: en
...
depends-on: []
related:
- agentictoolkit://cookbook/status-server/monitor/time-ago
- agentictoolkit://cookbook/status-web/hooks/use-now
...
[Status Server Monitor Time Ago](agentictoolkit://cookbook/status-server/monitor/time-ago);
...
| Platform | Path |
|----------|------|
| web | `packages/web/packages/status-web/src/lib/time-ago.ts` |

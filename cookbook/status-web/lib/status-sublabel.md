...
domain: agentictoolkit://cookbook/status-web/lib/status-sublabel
type: ingredient
version: 1.0.1
status: review
language: en
...
tags: []
depends-on:
- agentictoolkit://cookbook/status-web/lib/row-model
- agentictoolkit://cookbook/status-web/lib/overview
related: []
references: []
approved-by: ''
approved-date: ''

...
domain: agentictoolkit://cookbook/status-web/lib/row-model
type: ingredient
version: 1.0.1
status: review
language: en
...
- agentictoolkit://cookbook/status-web/lib/format
- agentictoolkit://cookbook/status-web/lib/deploy-status
- agentictoolkit://cookbook/status-web/lib/colors
- agentictoolkit://cookbook/status-web/lib/issue-sources
related: []
references: []
approved-by: ''
approved-date: ''

...
domain: agentictoolkit://cookbook/adh-ui/blocks/delete-entity-section
type: recipe
version: 1.3.1
status: review
language: en
...
- agentictoolkit://cookbook/focused-topic-detail
references: []
approved-by: ""
approved-date: ""
---
...
- **React/Web**: `packages/web/packages/adh-ui/src/blocks/delete-entity-section.tsx`
  ...
  (`agentictoolkit://cookbook/focused-topic-detail`), usually as the final
...
| Platform | Path |
|----------|------|
| web | `packages/web/packages/adh-ui/src/blocks/delete-entity-section.tsx` |

...
domain: agentictoolkit://cookbook/adh-ui/blocks/invitation-panes
type: ingredient
version: 1.1.1
status: review
language: en
...
- agentictoolkit://cookbook/adh-ui/blocks/send-invitation-modal
...
`SendInvitationModal` (agentictoolkit://cookbook/adh-ui/blocks/send-invitation-modal) and

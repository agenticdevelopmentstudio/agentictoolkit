...
title: useUptime
domain: agentictoolkit://recipes/status-web-hooks-use-uptime
type: ingredient
version: 1.0.0
status: review
language: en
...
related:
- agentictoolkit://recipes/status-web-hooks-use-response-history

...
domain: agentictoolkit://recipes/status-web-src-lib-url
type: ingredient
version: 1.0.0
status: review
language: en
...
- agentictoolkit://recipes/status-web-src-lib-row-detail
- agentictoolkit://recipes/status-web-src-lib-stale-monitors
references:

...
domain: agentictoolkit://recipes/extension-host-vs-code-api-ns-alert-message-presenter
type: ingredient
version: 1.0.0
status: review
language: en
...
- sheet
depends-on:
- agentictoolkit://recipes/extension-host-vs-code-api-extension-message-presenting
related: []
references:

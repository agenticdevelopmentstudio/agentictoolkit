...
title: JSValueBridge
domain: agentictoolkit://recipes/extension-host-vs-code-api-js-value-bridge
type: ingredient
version: 1.0.0
status: review
language: en
...
- agentictoolkit://recipes/extension-host-vs-code-api-extension-input-box-presenting
- agentictoolkit://recipes/extension-host-vs-code-api-extension-status-bar-presenting
- agentictoolkit://recipes/extension-host-vs-code-api-ai-plugin-language-model-provider
- agentictoolkit://recipes/extension-host-vs-code-api-extension-quick-pick-presenting

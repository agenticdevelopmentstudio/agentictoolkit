...
domain: agentictoolkit://recipes/system-permissions
type: ingredient
version: 1.0.0
status: review
language: en
...
- agentictoolkit://recipes/permissions-panel-view
references:
...
Use it wherever an app or daemon has to show or obtain a privacy grant; the UI that renders it lives in [PermissionRowView](agentictoolkit://recipes/permission-row-view) and [PermissionsPanelView](agentictoolkit://recipes/permissions-panel-view).

...
domain: agentictoolkit://recipes/git-client-projects-projects-coordinator
type: ingredient
version: 1.0.0
status: review
language: en
...
- agentictoolkit://recipes/git-client-projects-project-reconciler
- agentictoolkit://recipes/git-client-projects-git-repo-scanner
- agentictoolkit://recipes/git-client-projects-project-chooser-window
- agentictoolkit://recipes/git-client-projects-project-scan-progress-window
